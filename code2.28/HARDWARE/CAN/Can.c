...
//		#endif
	...
	RDSS_TX.RDSS_TX_BUFF2[24]=SYS.EQID[0];
	RDSS_TX.RDSS_TX_BUFF2[25]=SYS.EQID[1];
	RDSS_TX.RDSS_TX_BUFF2[26]=SYS.EQID[2];
	RDSS_TX.RDSS_TX_BUFF2[27]=SYS.EQID[3];
	RDSS_TX.RDSS_TX_BUFF2[28]=SYS.EQID[4];
	RDSS_TX.RDSS_TX_BUFF2[29]=SYS.EQID[5];
	RDSS_TX.RDSS_TX_BUFF2[30]=SYS.EQID[6];
	RDSS_TX.RDSS_TX_BUFF2[31]=SYS.EQID[7];
	
	RDSS_TX.RDSS_TXBUFF2_LEN=32;
}
